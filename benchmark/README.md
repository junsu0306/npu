...
```bash
cd /workspace/etri_iitp/JS/npu

python3 benchmark/model_zoo/run_smoke_test.py \
  --model-class ViT_Tiny_Patch16_224 \
  --mxq assets/mxq/tiny30__paper__rel002_npusafe_vt_global8.mxq \
